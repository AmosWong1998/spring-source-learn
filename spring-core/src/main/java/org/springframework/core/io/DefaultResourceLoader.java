...
public class DefaultResourceLoader implements ResourceLoader {
	...
	public Resource getResource(String location) {
		...
		// 如果location 以 / 开头 返回 ClassPathContextResource 类型的资源
		...
		/* 其他情况 根据是否为文件 URL ，是则返回 FileUrlResource 类型的资源，
											否则返回 UrlResource 类型的资源
		 如：file:/Users/spark.txt 或者 http://www.baidu.com 指定有协议前缀的资源路径，
		 ...
		 */
			...
			try {
				...
				// 全部都不符合，会抛出MalformedURLException异常，然后返回 ClassPathContextResource 类型的资源
				return getResourceByPath(location);
			}
		}
	}
